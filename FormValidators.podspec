...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FormValidators.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Juvenal Guzman/FormValidators'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Juvenal Guzman' => 'juvenal.guzman@gmail.com' }
  s.source           = { :git => 'https://github.com/Juvenal Guzman/FormValidators.git', :tag => s.version.to_s }
